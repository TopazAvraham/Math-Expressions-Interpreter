 ...
 * This class is used to represent the logical connective "Xor".
 */
public class Xor extends BinaryExpression {
    ...
    public Boolean evaluate(Map<String, Boolean> assignment) throws Exception {
        return implementXor(getExpression1().evaluate(assignment), getExpression2().evaluate(assignment));
    }

    /**
     * this method is used to evaluate the result of the expression after calculating the "Xor" operator on it.
     ...
     */
    public boolean implementXor(boolean resE1, boolean resE2) {
        return resE1 ^ resE2;
    }
    @Override
    ...
    public Expression nandify() {
     //   = [ A NAND ( A NAND B ) ]     NAND     [ B NAND ( A NAND B ) ]
        ...
        Nand nand1 = new Nand(getExpression1().nandify(),
                new Nand(getExpression1().nandify(), getExpression2().nandify()));

        Nand nand2 = new Nand(getExpression2().nandify(),
                new Nand(getExpression1().nandify(), getExpression2().nandify()));
    ...
    public Expression norify() {
        ...
        Nor nor2 = new Nor(getExpression1().norify(), getExpression2().norify());
